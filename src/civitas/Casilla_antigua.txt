...
public class Casilla_antigua {
    ...
    /*----------------------Constructores----------------------*/
    Casilla_antigua(String nombre){
        init();
        tipo = TipoCasilla.DESCANSO;
        this.nombre = nombre;
    }

    Casilla_antigua(TituloPropiedad titulo){
        init(); 
    ...
    Casilla_antigua(float cantidad, String nombre){
        init();
        importe = cantidad;
    ...
    Casilla_antigua(int numCasillaCarcel, String nombre) {
        init();
        this.nombre = nombre;
    ...
    Casilla_antigua(MazoSorpresas mazo, String nombre){
        init();
        this.nombre = nombre;
