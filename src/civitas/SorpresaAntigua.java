...
public class SorpresaAntigua{
    ...
    SorpresaAntigua(TipoSorpresa tipo, Tablero tablero) {
        init();
    ...
    SorpresaAntigua(TipoSorpresa tipo, Tablero tablero, int valor, String texto){
        init();
        this.tablero=tablero;
    ...
    SorpresaAntigua(TipoSorpresa tipo, int valor, String texto){       // Resto de sorpresas
        init();
        this.tipo = tipo;
        this.texto = texto;
        this.valor = valor;
    ...
    SorpresaAntigua(TipoSorpresa tipo, MazoSorpresas mazo){
        init();
        this.mazo = mazo;
